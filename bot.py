    ...
    try:
        ...
        for name, addr in tokens.items():
            ...
            msg = (
                ...
                f"[Pepuswap](https://www.pepuswap.com/) | [Explorer](https://www.pepuscan.com/)"
            )
...
async def chapter(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await update.message.reply_text(f"📘 *Unlocked Chapters*\n{row}\n\n[Pepuswap](https://www.pepuswap.com/) | [Explorer](https://www.pepuscan.com/)", parse_mode=ParseMode.MARKDOWN, disable_web_page_preview=True)
    except Exception as e:
        await update.message.reply_text(f"❌ Error: {e}")
